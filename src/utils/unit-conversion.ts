...
const units: Record<string, UnitDefinition> = {
  ...
  cm: {
    ...
    symbol: "cm",
    category: "length",
    toBase: (v) => v * 37.795276,
    fromBase: (v) => v / 37.795276,
  },
  mm: {
    name: "millimeters",
    symbol: "mm",
    category: "length",
    toBase: (v) => v * 3.779528,
    fromBase: (v) => v / 3.779528,
  },
  m: {
    name: "meters",
    symbol: "m",
    category: "length",
    toBase: (v) => v * 3779.527559,
    fromBase: (v) => v / 3779.527559,
  },
  km: {
    name: "kilometers",
    symbol: "km",
    category: "length",
    toBase: (v) => v * 3779527.559,
    fromBase: (v) => v / 3779527.559,
  },
  ft: {
    name: "feet",
    symbol: "ft",
  ...
  ac: {
    ...
    symbol: "ac",
    category: "area",
    toBase: (v) => v * 4046.856422,
    fromBase: (v) => v / 4046.856422,
  },
...
export const formatConversionResultForCopy = (
